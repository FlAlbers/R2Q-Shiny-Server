...
#    row_spec(0,color = " #43d320 ") %>%
#    as_image(width = 8) %>%
#  kable_as_image(width = 8)
```
...
```{r ,results="asis", echo= FALSE}
  ...
  #kable_as_image(width = 8)
kable(mtcars, "html") %>%  
save_kable(file = "C:/Users/fl-al/Google Drive/R/R2Q_App/R2Q_App_VCurrent/tables/test.png")
#kable(mtcars, "html") %>%
  #kable_styling("striped") %>%
  #row_spec(1, color = "red") %>%
  #save_kable(file= "./kableimage.jpeg")
  #knitr::include_graphics(path = "./kableimage")
